...
from .tools.kimi_formula_web_search import get_formula_web_search_registration
...
def register(ctx) -> None:
    ...
    registrations = [get_formula_web_search_registration(), *get_formula_tool_registrations()]
